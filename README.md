...
- G2-27 — Self-Construction Minimum Gate: **PROVEN** (the gate mechanism — real, independent, doubly-adversarially-reviewed verification apparatus). Its own genuine result: **`SELF_CONSTRUCTION_CAPABLE = FALSE`**, blocked by SC-16 (evidence_packet's provenance/detector-binding checks, honestly unbuilt since G2-19) and SC-23 (no Gen2-owned, qualified, mutating repository-construction Facility — G2-14's own critical gate remains active). Review/proof record: `docs/gen2/G2-27-review-record.md`.
