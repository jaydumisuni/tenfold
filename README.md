...
- G2-04 — Independent Verifier Specification and Core: **PROVING** (real hostile review pending). Review/proof record: `docs/gen2/G2-04-review-record.md`.
- Current next Gen-2 milestones: **G2-03 — Constitutional Mutation Suite** (also ready, not yet started — its Rust Trust Table deliverable is scoped but deliberately sequenced after G2-04) and **G2-04** (in review).
