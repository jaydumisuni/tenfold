...
import workspace.pete_phase14_campaign_v4  # installs generation-3 binding
from tenfold.contracts import canonical_digest

PETE_HEAD = "9f493772e3c1e8baa6afcc3f230262fdf71a2e2b"
HUNTER_HEAD = "18dc8bea1c94982b9744aa24a2d63ca489d998f0"
...
def rebound_blueprint():
    return replace(_original_blueprint(), generation=4)
...
def rebound_campaign(blueprint):
    ...
    return replace(
        ...
        generation=4,
        compiler_version="4",
        compiler_digest=canonical_digest({"compiler": "pete-phase14-workspace-deriver", "version": 4}),
    )
