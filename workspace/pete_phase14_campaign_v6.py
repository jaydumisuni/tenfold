...
import workspace.pete_phase14_campaign_v5  # installs generation-4 binding
from tenfold.contracts import canonical_digest

PETE_HEAD = "9f493772e3c1e8baa6afcc3f230262fdf71a2e2b"
HUNTER_HEAD = "affc4ba01af4594fd8a8b5a4b4d26a6bfdacbec8"
...
def rebound_blueprint():
    return replace(_original_blueprint(), generation=5)
...
def rebound_campaign(blueprint):
    ...
    return replace(
        ...
        generation=5,
        compiler_version="5",
        compiler_digest=canonical_digest({"compiler": "pete-phase14-workspace-deriver", "version": 5}),
    )
