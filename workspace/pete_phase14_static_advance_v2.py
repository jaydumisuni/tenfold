...
import workspace.pete_phase14_campaign_v8  # installs current generation-7 binding
...
EXPECTED = {
    "STATIC_PETE_REVIEW": {
        ...
        "pr": 19,
        "head": "b1f351e9808807f8df89b5db03efd681dd5ccf79",
    ...
    "STATIC_HUNTER_REVIEW": {
        ...
        "pr": 174,
        "head": "b65457589cbf2a7574de15f1017e9c5b4bdaf266",
        "officer": "security",
    },
    "STATIC_ADMIN_REVIEW": {
        ...
        "pr": 17,
        "head": "efc76a5269232126911f4efd6d5ba88646458418",
        "officer": "integration",
    },
}
...
def main() -> int:
    ...
    if manifest.generation != 7 or blueprint.generation != 7:
    ...
    derivation = independently_assure(
        ...
        reviewer_method="exact-generation-7-cross-check-v1",
    )
    if not derivation.passed:
        raise RuntimeError(f"generation 7 derivation failed:{derivation.findings}")
